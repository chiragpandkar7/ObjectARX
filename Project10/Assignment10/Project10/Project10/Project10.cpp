// Project10.cpp : Defines the initialization routines for the DLL.
//
...
void CProject10App::changeColor()
{
	ads_name sset, ename;
...
extern "C" AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt)
{
	...
	case AcRx::kInitAppMsg:
		...
		acedRegCmds->addCommand(_T("AUCommands"), _T("ChangeColor"), _T("ChangeColor"), ACRX_CMD_MODAL, &CProject10App::changeColor);
		break;
...
BEGIN_MESSAGE_MAP(CProject10App, CWinApp)
END_MESSAGE_MAP()


// CProject10App construction

CProject10App::CProject10App()
{
...
// The one and only CProject10App object

CProject10App theApp;


// CProject10App initialization

BOOL CProject10App::InitInstance()
{
