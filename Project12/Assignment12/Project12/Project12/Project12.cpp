// Project12.cpp : Defines the initialization routines for the DLL.
//
...
// The one and only CProject12App object

CProject12App theApp;


// CProject12App initialization
