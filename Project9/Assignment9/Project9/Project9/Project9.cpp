// Project9.cpp : Defines the initialization routines for the DLL.
//
...
// The one and only CProject9App object

CProject9App theApp;


// CProject9App initialization
